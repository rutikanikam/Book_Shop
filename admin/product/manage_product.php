...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="product-form">
			...
			<div class="form-group">
				<label for="b_weight" class="control-label">Book Weight</label>
                <textarea name="b_weight" id="" cols="30" rows="2" class="form-control form no-resize"><?php echo isset($b_weight) ? $b_weight : ''; ?></textarea>
			</div>
            <div class="form-group">
