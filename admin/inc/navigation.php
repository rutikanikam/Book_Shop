              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=upcoming_book" class="nav-link nav-upcoming_book">
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=subscription" class="nav-link nav-subscription">
					...
					<li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=our_distributors" class="nav-link nav-our_distributors">
