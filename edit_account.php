				...
				<div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
							...
							<div class="form-group">
                                <label for="middle_name" class="control-label">Middlename</label>
                                <input type="text" name="middle_name" class="form-control form" value="<?php echo $_settings->userdata('middle_name') ?>" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="contact" class="form-control form" value="<?php echo $_settings->userdata('contact') ?>" required>
                            </div>
                            <div class="form-group">
							 ...
							 <div class="form-group">
                                ...
                                <input type="text" name="town" class="form-control form" value="<?php echo $_settings->userdata('town') ?>" required>
                            </div>
							 <div class="form-group">
                                <label for="pincode" class="control-label">Pincode</label>
                                <input type="number" name="pincode" class="form-control form" value="<?php echo $_settings->userdata('pincode') ?>" required>
                            </div>
							</div>
							<div class="col-md-6">
							 <div class="form-group">
                                <label for="taluka" class="control-label">Taluka</label>
                                <input type="text" name="taluka" class="form-control form" value="<?php echo $_settings->userdata('taluka') ?>" required>
                            </div>
							<div class="form-group">
                                <label for="district" class="control-label">District</label>
                                <input type="text" name="district" class="form-control form" value="<?php echo $_settings->userdata('district') ?>" required>
                            </div>
							 <div class="form-group">
                                <label for="state" class="control-label">State</label>
                                <input type="text" name="state" class="form-control form" value="<?php echo $_settings->userdata('state') ?>" required>
                            </div>
                            <div class="form-group">
