<nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid px-4 px-lg-5 ">
                ...
                <div style="font-weight:800;" class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        // </li>-->
                         ...
                         <?php endwhile; ?>
                        <?php if($count_cats > 3): ?>
                        <li class="nav-item"><a class="nav-link" href="./?p=view_categories">Book Categories</a></li>
                        <?php endif; ?>
						<li class="nav-item"><a class="nav-link" href="./?p=distributors">Our Distributors</a></li>
