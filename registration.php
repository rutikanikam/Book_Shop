        ...
        <div class="row  align-items-center h-100">
            ...
            <div class="col-lg-5 border-right">
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm form" name="middle_name">
                </div>
                <div class="form-group">
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm form" name="town" required>
                </div>
            </div>
            <div class="col-lg-7">
				<div class="form-group">
                    <label for="" class="control-label">Pincode</label><br>
                    <input type="number" class="form-control form-control-sm form" name="pincode" required>
                </div>
				<div class="form-group">
                    <label for="" class="control-label">Taluka</label>
                    <input type="text" class="form-control form-control-sm form" name="taluka" required>
                </div>
				<div class="form-group">
                    <label for="" class="control-label">District</label>
                    <input type="text" class="form-control form-control-sm form" name="district" required>
                </div>
				<div class="form-group">
                    <label for="" class="control-label">State</label>
                    <input type="text" class="form-control form-control-sm form" name="state" required>
                </div>
				<div class="form-group">
